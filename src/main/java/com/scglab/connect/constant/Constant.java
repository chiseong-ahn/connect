...
public class Constant {
	...
	public final static String	SOCKET_BASE_URI = "/ws-stomp";
	public final static String	SOCKET_ROOM_PREFIX = "/sub/chat/room/";		// 소켓 채널의 prefix
	public final static String	SOCKET_RECEIVE_URI = "/talk/message";		// 소켓 채널의 prefix
	
	public final static long	JSONTOKEN_EXPIRE = 60 * 60 * 24 * 100;		// 토큰의 유효기간 
