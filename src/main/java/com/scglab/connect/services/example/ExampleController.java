...
public class ExampleController {
	...
	public Map<String, Object> object(@RequestParam Map<String, Object> params, @PathVariable String id)
			throws Exception {
		params.put("id", id);
	...
	public Map<String, Object> delete(@PathVariable long id, @RequestParam Map<String, Object> params)
			throws Exception {
		params.put("id", id);
