...
@RestController
@RequestMapping(name = "상담조회", value="/api/chattalk")
public class ChatController {
	...
	@RequestMapping(name="중계서버에서 chatid로 상담조회", method = RequestMethod.GET, value = "/conversations/{chatId}.xml", produces = MediaType.APPLICATION_JSON_VALUE)
