...
public class LoginController {
	...
	public Map<String, Object> loginAdmin(@RequestBody Map<String, Object> params, HttpServletRequest request,
	...
	public Map<String, Object> loginMember(@RequestBody Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public Map<String, Object> loginCustomer(@RequestBody Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
