...
public class LoginService {
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> loginAdmin(Map<String, Object> params, HttpServletRequest request,
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> loginMember(Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Map<String, Object> data = new HashMap<String, Object>();
	 ...
	 * @throws Exception
	 */
	public Member profile(Map<String, Object> params, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		// Token에서 회원정보 추출.
