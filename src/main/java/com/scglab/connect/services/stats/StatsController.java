...
public class StatsController {
	...
	public Map<String, Object> regist(@RequestParam Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		return this.statsService.member(params, request, response);
	}

	@Auth
	@RequestMapping(name = "통계 : Today 나의 상담현황", method = RequestMethod.GET, value = "myToday", produces = MediaType.APPLICATION_JSON_VALUE)
	public StatsMyToday myToday(@RequestParam Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public StatsCompany search(@RequestParam Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public List<Map<String, Object>> customerAnalysis(@RequestParam Map<String, Object> params,
	...
	public List<StatsCompany> useHistory(@RequestParam Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public List<Map<String, Object>> hashtag(@RequestParam Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
	...
	public Map<String, Object> review(@RequestParam Map<String, Object> params, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
