...
public class SampleController {
	...
	@Auth
	@RequestMapping(method = RequestMethod.GET, name = "샘플 목록조회", value = "", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@Auth
	@RequestMapping(method = RequestMethod.GET, name = "샘플 상세조회", value = "/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@Auth
	@RequestMapping(method = RequestMethod.POST, name = "샘플 등록", value = "", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@Auth
	@RequestMapping(method = RequestMethod.PUT, name = "샘플 수정", value = "", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@Auth
	@RequestMapping(method = RequestMethod.DELETE, name = "샘플 삭제", value = "", produces = MediaType.APPLICATION_JSON_VALUE)
